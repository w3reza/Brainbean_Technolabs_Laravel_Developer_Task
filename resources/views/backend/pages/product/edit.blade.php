                        ...
                        <div class="row align-items-center pt-2 pb-1"> <!--row Start -->
                            ...
                            <div class="col-md-10 pe-5">
                                <input type="text" name="brand_name"
                                    ...
                                    placeholder="Brand Name" value="{{ old('brand_name')  ?? $product->brand_name }}" />
                                @error('brand_name')
                                    <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row align-items-center pt-2 pb-1"> <!--row Start -->
                            ...
                            <div class="col-md-10 pe-5">
                                <input type="text" name="cost_price"
                                    ...
                                    placeholder="Cost Price" value="{{ old('cost_price')  ?? $product->cost_price }}" />
                                @error('cost_price')
                                    <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row align-items-center pt-2 pb-1"> <!--row Start -->
                            ...
                            <div class="col-md-10 pe-5">
                                <input type="text" name="sell_price"
                                    ...
                                    placeholder="Sell Price" value="{{ old('sell_price')  ?? $product->sell_price }}" />
                                @error('sell_price')
                                    <div id="validationServerUsernameFeedback" class="invalid-feedback">
                                        {{ $message }}
                                    </div>
